...
(function (window, $, undefined) {
    $.fn.stonePicker = function (config) {
        ...
        selfData.getChoose = function () {
            var result = [];
            Object.keys(selfData.choose).forEach(function (prop) {
        ...
        //
        config.defaulItems.forEach(function (prop) { selfData.choose[prop] = trueselfData.choose[prop] = true; } );
        ...
        config.data.forEach(function (item) {
            ...
            $stone.on('click', function () {
                ...
                if (!config.multi) {
                    ...
                    if (!choosed) {
                        ...
                        if (!config.multi) {
                            selfData.items.forEach(function ($item) {
                                if ($item != $stone) {
            ...
            function setValueToStone($elem, value) {
